...
def blast_sequences(sequence=None, fasta_file=None,
    ...
    sequence
      An ATGC string or a list of ATGC strings or a dict {name: seq:}
    ...
    if isinstance(sequence, (list, tuple)):
        sequence = {"seq_%d" % i: seq for i, seq in enumerate(sequence)}
...
def compute_all_overhangs(self, record, primer_length_range=(15, 25),
